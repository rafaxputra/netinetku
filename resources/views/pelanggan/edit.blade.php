...
<div class="container py-5">
    <div class="card glass-effect">
        ...
        <div class="card-body">
            ...
            @endif
            <form method="POST" action="{{ route('pelanggan.update', $pelanggan->user_id) }}">
                @csrf
                @method('PUT')

                <input type="hidden" name="user_id" value="{{ $pelanggan->user_id }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name"
                        value="{{ old('name', $pelanggan->user->name) }}" maxlength="255" autocomplete="off" required>
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email"
                        value="{{ old('email', $pelanggan->user->email) }}" maxlength="255" autocomplete="off" required>
                    @error('email')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="alamat" name="alamat" maxlength="255"
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="tanggal_pendaftaran" name="tanggal_pendaftaran"
                        value="{{ old('tanggal_pendaftaran', $pelanggan->tanggal_pendaftaran) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="status" name="status" required>
                        <option value="aktif" {{ old('status', $pelanggan->status) == 'aktif' ? 'selected' : '' }}>Aktif
                        </option>
